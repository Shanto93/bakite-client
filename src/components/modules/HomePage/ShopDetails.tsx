      ...
      <div className="container mx-auto px-4 text-center max-w-4xl">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative w-full max-w-2xl">
            ...
            />
            <button
              className="absolute top-1/2 right-2 -translate-y-1/2 bg-[#0aa9a2] text-white font-semibold px-6 py-2 rounded-md hover:bg-[#08918a] transition-colors"
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          {locations.map((location) => (
            <button
              key={location}
              className="flex items-center gap-2 bg-gray-100 text-gray-700 font-medium px-4 py-2 rounded-full border border-gray-200 hover:bg-[#0aa9a2]/10 hover:text-[#0aa9a2] transition-colors"
            >
              <FiMapPin />
              <span>{location}</span>
            </button>
